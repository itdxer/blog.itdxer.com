...
begins with a fixed bet (e.g., 1\$) and continues until we either win or can no
longer double the previous amount.
...
\\(1/2^K\\) probability or win 1\$ in which case conditional expectation will be
